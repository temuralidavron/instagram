...
# Bizga user rasmi, username,image,like bosish imkoniyat,likelar soni, postlar soni kerak
...
class PostSerializer(serializers.ModelSerializer):
    ...
    post_likes_count = serializers.SerializerMethodField('get_post_like_count')
